...
namespace AlterMVTestPlayer {
    ...
    public static class WindowsRunner {
        ...
        public static int Run() {
            ...
            if (Program.TestMode) {
                ...
                if (Program.OldVersion)
                    executionLine = $"\"{Program.NWExe}\" --nwapp --url=\"{Program.TargetProjectEntry}?test\"";
                ...
                if (Program.OldVersion)
                    executionLine = $"\"{Program.NWExe}\" --nwapp --url=\"{Program.TargetProjectEntry}\"";
        ...
        private static bool DownloadNodeWebkit()
        {
            ...
            switch (Program.Architecture) {
                ...
                case Architecture.X86:
                    ...
                    if (Program.OldVersion)
                        DownloadTarget = @"https://dl.nwjs.io/v0.12.3/nwjs-v0.12.3-win-ia32.zip";
                    
                    else
                        DownloadTarget = @"https://dl.nwjs.io/v0.44.1/nwjs-v0.44.1-win-x64.zip";
                ...
                case Architecture.X64:
                    ...
                    if (Program.OldVersion)
                        DownloadTarget = @"https://dl.nwjs.io/v0.12.3/nwjs-v0.12.3-win-x64.zip";
